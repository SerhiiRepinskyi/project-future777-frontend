// FIXME: Юля, перевір - те що написано не завжди вірно!
const YUP_NAME1_ERR = 'Name must be at least 2 characters';
const YUP_NAME2_ERR = 'Name must be at most 32 characters';
const YUP_NAMEREGEXP_ERR = 'Only Latin letters are allowed'; // FIXME:
const INPUT_NAME_TITLE =
  'Only letters, digits, and certain symbols are allowed.';

const YUP_EMAIL_ERR = 'Invalid email format';
const YUP_EMAIL_REQ = 'Email is required';
const INPUT_EMAIL_TITLE = 'Please enter a valid email address';
